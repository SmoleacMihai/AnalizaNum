...
int main()
{
    ...
    cout << "Dati epsilon: "; cin >> eps;

    cout << "Dati pasul: "; cin >> h;
...
void Linia(int st, int lin, int mij, int dr)
{
    ...
    for (i = 1; i <= 10; i++) printf("%c", lin); printf("%c", dr); // Verificare
}
void Print(double A, double B, int k) {
    double x;
    ...
    x = Bisection(A, B, k);
    printf("\n%cBisectia %12c %d %5c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
    Linia(199, 196, 197, 186);
    x = Newton(A, B, k);
    printf("\n%cNewton %14c %d %6c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
    Linia(199, 196, 197, 186);
    x = ModificataTangentelor(A, B, k);
    printf("\n%cModifTangentelor %4c %d %6c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
    Linia(199, 196, 197, 186);
    x = Secantelor(A, B, k);
    printf("\n%cSecantelor %10c %d %6c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
    Linia(199, 196, 197, 186);
    x = Coardelor(A, B, k);
    printf("\n%cCoardelor %11c %d %6c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
    Linia(199, 196, 197, 186);
    x = Mixta(A, B, k);
    printf("\n%cMixta %15c %d %6c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
    Linia(199, 196, 197, 186);
    x = SimpleIteratiilor(A, B, k);
    printf("\n%cSimpleIteratiilor %3c %d %6c%15.12lf %2c%10.3le%c", 186, 179, k, 179, x, 179, f(x), 186);
...
{
    double x0 = a, x1 = b;
    double x2 = Chord(x0, x1), x3 = Newton(x1);
    double delta;
...
double f1(double x) {
    return pow(7 * x + 42 - 6 * x * x, 1 / 3);
}

double f2(double x) {
    return pow((-x * x * x + 42 + 7 * x)*1/6, 1 / 2);
}

double f3(double x) {
    return (x * x * x - 42 + 6 * x * x) * 1 / 7;
}
